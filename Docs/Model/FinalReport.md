...
The final aspect of our project is to design a dashboard that is intended to be interactive and  a tool to assist healthcare professionals in analyzing cancer drug repsonse. The goal is to allow users to input a cancer related profile and recieve both predicted drug responses and a ranked comparision of different treatment options.
